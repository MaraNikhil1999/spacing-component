...
const props = withDefaults(defineProps<Props>(), {
    ...
    suggestions: () => [
        { key: 'applyToAll', displayName: 'Apply current value to all', forAll: true },
        { key: '0px', displayName: 'set value to 0px', value: '0px' }
    ],
    ...
    <div class="main">
        ...
        <div class="flex flex-veritcal margin-box">
            <SpacingComponent
                ...
                :drop-down-options="props.suggestions"
                spacing-position="top"
                spacing-type="margin"
            ...
            <div class="flex">
                ...
                <div class="padding-box">
                    ...
                    <div class="flex">
                        <SpacingComponent
                            :initial-spacing="initialPadding.left"
                            :show-suggestions="props.showSuggestionsForPadding"
                            :drop-down-options="props.suggestions"
                            spacing-position="left"
                            spacing-type="padding"
                        ...
                        <SpacingComponent
                            :initial-spacing="initialPadding.right"
                            :show-suggestions="props.showSuggestionsForPadding"
                            :drop-down-options="props.suggestions"
                            spacing-position="right"
                            spacing-type="padding"
                    ...
                    <SpacingComponent
                        :initial-spacing="initialPadding.bottom"
                        :show-suggestions="props.showSuggestionsForPadding"
                        :drop-down-options="props.suggestions"
                ...
                <SpacingComponent
                    :initial-spacing="initialMargin.right"
                    :show-suggestions="props.showSuggestionsForMarigin"
                    :drop-down-options="props.suggestions"
                    spacing-position="right"
                    spacing-type="margin"
            ...
            <SpacingComponent
                :initial-spacing="initialMargin.bottom"
                :show-suggestions="props.showSuggestionsForMarigin"
                :drop-down-options="props.suggestions"
                spacing-position="bottom"
                spacing-type="margin"
